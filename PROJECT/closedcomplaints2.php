...
?>
     ...
     <div class="words"><span>BELOW IS A LIST OF POLICE CLOSED COMPLAINTS:</span></div>
     <div class="search">
        ...
        <tbody>
            ...
            require './includes/conn.php';
                $query3= "SELECT POLICECOMPLAINTID,BADGENO,IncidentDATE,CITY,STREET,IncidentDESC,USERID,PCOMPSTATUS from complaintpolice WHERE USERID=$filter and PCOMPSTATUS='CLOSED'";
                    ...
                    foreach($query_run as $items){
                        ?>
                         <tr>
                            ...
                            <form action="./admin/folders/policefinalpdf.php" method="POST">
