...
<body>
    <div><a href="admin.php"><img src="../img/android-chrome-192x192.png" class="logo" alt="TETA"></a>
    </div>
    <div class="main">
        <form id ="form" class="form1" action="./registerset.php" method="POST" enctype="multipart/form-data" >
            <h1>Register Investigating Officer</h1>
            <small>
            <?php
            if(isset($_GET["error"])){
        ...
        <div class="up">
            <span >Already an Investigator?</span>
            <a href="../investigator/indexpage.php">Login</a>
        </form>
