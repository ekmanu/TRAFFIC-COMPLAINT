<?php
 ...
 use Dompdf\Dompdf;
    ...
    $document=new Dompdf();
    $kuf = "SELECT dreport.IncidentDATE,dreport.DRIVERCOMPLAINTID, dreport.CARREG,dreport.CITY,dreport.STREET,dreport.IncidentDESC,dreport.DCOMPSTATUS,dreport.Judgement,dreport.STATUSS, driver.OWNERNAME
    FROM dreport INNER JOIN driver ON dreport.CARREG=driver.CARREG WHERE dreport.DRIVERCOMPLAINTID='$pd';";
        ...
        <div class="headie">
            ...
            <div class="rest">
                    <div class="part1">
                        ...
                        <div class="division2">  
                            <div class="part2">OFFENDERS CARNO:.</div>
