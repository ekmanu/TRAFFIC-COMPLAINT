...
if(isset($_POST['DELETE']))
{
    include ('../includes/conn.php');
    $id = $_POST['edit_id'];
    $send= "DELETE FROM driver where OWNERID= '$id'";
     mysqli_query($conn,$send);
     header("location: ./admdriver.php?error=deleted");

}

?>
<div class="main">
        <form id ="form" class="form1" action="./editdriverfunction.php" method="POST" enctype="multipart/form-data" >
        ...
        <div class="forms" >
            ...
            <input type="text" value="<?php echo $finame?>" name="funame" placeholder="Enter  Name">
            <small>
        ...
        <div class="forms">
         ...
         <div class="forms">
            ...
            <div class="forms">
            <label for="secondname">CAR REG</label>
            <input type="text" value="<?php echo $reg?>" name="regi" placeholder="Enter Second Name">
            <small>
          
            </small>
        </div>
            <div class="forms">
            <label for="secondname">CAR MAKE</label>
            <input type="text" value="<?php echo $ema?>" name="mako" placeholder="Enter Second Name">
            <small></small>
        </div>
        <div class="forms">
                <label for="emailaddress">CAR TYPE</label>
                <input type="text" value="<?php echo $type?>" name="typo" placeholder="Enter the POLICE STATION BASED">
                <small>  
                </small>
        </div>
        <div class="forms">
                <label for="emailaddress">COLOUR</label>
                <input type="text" value="<?php echo $sename?>" name="colour" placeholder="Enter the POLICE STATION BASED">
                <small>  
                </small>
        </div>
        <div class="forms">
