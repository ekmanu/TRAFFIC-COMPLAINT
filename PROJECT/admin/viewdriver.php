...
<table>
        ...
        <tbody>
            ...
            include '../includes/conn.php';
                ...
                INNER JOIN users on complaintdriver.USERID=users.ID WHERE complaintdriver.DCOMPSTATUS='CLOSED';";
                    ...
                    foreach($query_run as $items){
                        ?>
                         <tr>
                            ...
                            <td><form action="../admin/folders/driverfinalpdf.php" method="post">
                                <input type="hidden" name="edit_id" value="<?php echo $items['DRIVERCOMPLAINTID']?>">
                                <input type="hidden" name="status" value="<?php echo $items['DCOMPSTATUS']?>">
                                <button id="edit" class="field1" name="editbtn">VIEW REPORT</button></form>
                            </td>
