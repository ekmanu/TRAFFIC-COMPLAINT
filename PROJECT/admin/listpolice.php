...
<table>
        ...
        <tbody>
            ...
            include '../includes/conn.php';
                $query3= "SELECT BADGENO,FULLNAME,secondname,POLICESTATION,PhoneNumber,EMAIL,RESIDENCE,photo from policeofficer";
                    ...
                    foreach($query_run as $items){
                        ?>
                         <tr>
                            ...
                            <div class="people-de">
                                <h5><?= $items['FULLNAME'] ." ". $items['secondname'];?></h5>
                            ...
                            <td><?= $items['BADGENO']; ?></td>
                            <td><?= $items['EMAIL']; ?></td>
                            <td><?= $items['POLICESTATION']; ?></td>
                            <td><?= $items['RESIDENCE']; ?></td>
                            <td> <form action="editpolisi.php" method="post">
                                <input type="hidden" name="edit_id" value="<?php echo $items['BADGENO']?>">
                                <input type="hidden" name="finame" value="<?php echo $items['FULLNAME']?>">
                                ...
                                <input type="hidden" name="ema" value="<?php echo $items['POLICESTATION']?>">
