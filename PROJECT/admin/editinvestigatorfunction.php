...
if(isset($_POST['submit']))
{
    ...
    $number = $_POST['phone'];
    $eadd = $_POST['address'];
    $send= "UPDATE investigators set InvestID= ?, Firstname=?, Secondname=?, phonenumber=?,emailaddress=? where InvestID= ? ";
     ...
     if(mysqli_stmt_prepare($chick, $send)){
        ...
        header("location: ./editinvestigators.php?error=notassigned");
     }
